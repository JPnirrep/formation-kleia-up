  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 p-4 bg-white/80 backdrop-blur-xl rounded-kleia border border-kleia-gold/30 shadow-gold">
        ...
        <button 
          onClick={onClose}
          className="ml-2 p-1 hover:bg-kleia-dark/5 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-kleia-gold focus-visible:ring-offset-2 focus-visible:outline-none"
