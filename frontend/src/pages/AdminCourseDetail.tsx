            ...
            <Card key={mod.id} className="overflow-hidden">
              ...
              >
                <div className="flex items-center gap-1">
                  ...
                  <div>
                    <h2 className="font-heading font-bold text-kleia-dark">{mod.title}</h2>
                    ...
                    <div className="p-4 bg-kleia-cream/50 border-b border-kleia-dark/10">
                      <div className="flex items-center gap-3 mb-2">
                        <input
                          ...
                          className="flex-1 px-3 py-1.5 rounded border border-kleia-dark/20 text-sm font-body outline-none focus:border-kleia-violet focus:ring-2 focus:ring-kleia-gold focus:ring-offset-1"
                          autoFocus
                        />
                        <select value={newLessonType} onChange={(e) => setNewLessonType(e.target.value)} className="px-2 py-1.5 rounded border border-kleia-dark/20 text-sm font-body bg-white" aria-label="Type de leçon">
                        ...
                        <input
                          ...
                          className="w-20 px-2 py-1.5 rounded border border-kleia-dark/20 text-sm font-body outline-none focus:ring-2 focus:ring-kleia-gold focus:ring-offset-1"
                          placeholder="Durée (s)"
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-medium font-body text-kleia-dark truncate">{lesson.title}</h3>
                          ...
                          {youtubeLessonId === lesson.id && (
                            <div className="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                              ...
                              <div className="flex items-center gap-2">
                                <input type="text" value={youtubeUrl} onChange={(e) => setYoutubeUrl(e.target.value)} placeholder="https://youtube.com/watch?v=XXXXXXXXXXX" aria-label="Lien YouTube" className="flex-1 px-3 py-1.5 rounded border border-kleia-dark/20 text-sm font-body outline-none focus:border-kleia-violet focus:ring-2 focus:ring-kleia-gold focus:ring-offset-1" autoFocus />
                                <input type="text" value={youtubeTitle} onChange={(e) => setYoutubeTitle(e.target.value)} placeholder="Titre (optionnel)" aria-label="Titre de la vidéo" className="w-40 px-3 py-1.5 rounded border border-kleia-dark/20 text-sm font-body outline-none focus:border-kleia-violet focus:ring-2 focus:ring-kleia-gold focus:ring-offset-1" />
                              </div>
                          ...
                          {editingLesson === lesson.id && (
                            <div className="mt-3">
                              <textarea
                                ...
                                rows={6}
                                className="w-full px-3 py-2 rounded border border-kleia-dark/20 text-sm font-body outline-none focus:border-kleia-violet focus:ring-2 focus:ring-kleia-gold focus:ring-offset-1 resize-y"
