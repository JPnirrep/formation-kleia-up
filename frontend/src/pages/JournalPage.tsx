  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {entries.length === 0 && !showNew ? (
        <Card className="text-center py-12">
          <BookOpen className="w-12 h-12 text-kleia-gray/30 mx-auto mb-4" />
          <p className="text-kleia-gray font-body text-lg">Aucune note pour le moment.</p>
          <p className="text-kleia-gray font-body text-sm mt-1">
            Créez votre première note pour commencer votre second cerveau.
          </p>
        </Card>
      ) : (
