...
export default function Courses() {
  ...
  useEffect(() => { document.title = 'Catalogue — Kleia-up'; }, []);
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course) => (
            <Link
              ...
              className="group block focus-visible:ring-2 focus-visible:ring-kleia-gold focus-visible:ring-offset-2 focus-visible:outline-none rounded-kleia"
            >
              <article className="glass-card overflow-hidden transition-all duration-300 group-hover:-translate-y-1 group-hover:shadow-[0_12px_40px_rgba(139,29,61,0.15)]">
                ...
                <div className="p-5">
                  ...
                  {/* Title */}
                  <h2 className="text-lg font-heading font-bold text-kleia-heading group-hover:text-kleia-burgundy transition-colors mb-2 line-clamp-2">
                    {course.title}
                  </h2>
