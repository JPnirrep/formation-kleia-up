...
export default function LessonView() {
  ...
  useEffect(() => { document.title = 'Leçon — Kleia-up'; }, []);
    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {videoEnded && !completed && lessonType === 'video' && (
            <div className="bg-kleia-success/10 border border-kleia-success/30 rounded-lg p-4 text-center">
              <p className="text-sm font-medium text-kleia-dark font-body">
                🎬 Vidéo entièrement visionnée — tu peux marquer cette leçon comme terminée.
              </p>
            </div>
          )}
