...
export default function ForgotPasswordPage() {
  useEffect(() => { document.title = 'Mot de passe oublié — Kleia-up'; }, []);
        ...
        <div className="bg-white/70 backdrop-blur-[16px] border border-white/20 shadow-glass rounded-2xl p-8 sm:p-10">
          ...
          {submitted ? (
            <div className="text-center space-y-6">
              ...
              <Link
                to="/login"
                className="inline-block text-sm text-kleia-violet font-medium hover:underline focus-visible:ring-2 focus-visible:ring-kleia-gold focus-visible:ring-offset-2 focus-visible:outline-none rounded"
              >
          ...
          <div className="mt-6 text-center">
            <Link to="/login" className="text-sm text-kleia-violet font-medium hover:underline focus-visible:ring-2 focus-visible:ring-kleia-gold focus-visible:ring-offset-2 focus-visible:outline-none rounded">
              Retour à la connexion
            </Link>
          </div>
        </div>
